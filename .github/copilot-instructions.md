# Copilot Instructions for SnoutSpotter

Read `AGENTS.md` at the repo root for full project context (architecture, file layout, data flow, API endpoints, DynamoDB schema).

## Key Rules

- **Region:** `eu-west-1`. Never hardcode AWS account IDs — use CDK `Account`/`Region` tokens.
